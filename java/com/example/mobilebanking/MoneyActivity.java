...
public class MoneyActivity extends AppCompatActivity {
    ...
    public void initComponents(){
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(valid())
                {
                    final Transaction tranzaction=createTranzaction();
    ...
    private Transaction createTranzaction(){
        String benef=etBeneficiar.getText().toString();
        String account=etAccount.getText().toString();
        Integer amount=Integer.parseInt(etAmount.getText().toString());
        String status=spnStatus.getSelectedItem().toString();
        return new Transaction(benef,account,status,amount,idUserTransaction);
    }

    private void onUpdate(Transaction tranzaction){
