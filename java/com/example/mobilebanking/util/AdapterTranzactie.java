...
public class AdapterTranzactie extends ArrayAdapter<Transaction> {
    ...
    public AdapterTranzactie(@NonNull Context context, int resource, @NonNull List<Transaction> tranzactions,LayoutInflater layout) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Transaction tranzaction =tranzactions.get(position);
        if(view==null)
        {
