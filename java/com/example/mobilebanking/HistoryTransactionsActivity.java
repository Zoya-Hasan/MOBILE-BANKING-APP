...
import com.example.mobilebanking.database.service.UserService;
import com.example.mobilebanking.json.HttpManager;
import com.example.mobilebanking.json.HttpResponse;
import com.example.mobilebanking.json.JsonParser;
...
import static com.example.mobilebanking.MoneyActivity.ADD_TRANZACTION_HISTORY;
...
private List<Transaction> transactions=new ArrayList<Transaction>();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((this.code == requestCode) && (resultCode == RESULT_OK) && (data != null)) {
            final Transaction transaction = data.getParcelableExtra(ADD_TRANZACTION_HISTORY);
