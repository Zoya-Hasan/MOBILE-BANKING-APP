...
List<Transaction> tranz=new ArrayList<>();
public static final String ADD_TRANZACTION_KEY = "addPTranzaction";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbar);
         intent=getIntent();
        initComponents();
        Transaction t1=new Transaction("Bianca","BRD100",100,"send");
        tranz.add((t1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD_TRANSACTION
                ...
                && data != null) {
            Transaction tranzaction = data.getParcelableExtra(MoneyActivity
